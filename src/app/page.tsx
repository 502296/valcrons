...
className="w-full bg-white/[0.03] border border-white/10 rounded-2xl py-5 pl-6 pr-32 focus:outline-none focus:ring-2 focus:ring-[#007AFF]/50 transition-all text-sm backdrop-blur-sm"
/>
