...
async function submitContactRequest() {
  ...
  function priorityStyle(value: string | null) {
    ...
    return "border-black/10 bg-[#f8f6f1] text-[#374151]";
  }
      ...
      <main className="min-h-screen bg-[#f8f6f1] text-[#111827]">
        ...
        <section className="px-6 pb-28 pt-36">
          <div className="mx-auto max-w-3xl rounded-[2rem] border border-black/10 bg-white p-10 text-center shadow-sm">
            ...
            <h1 className="mt-4 text-4xl font-bold tracking-[-0.04em] text-[#111827] md:text-5xl">
            ...
            <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
              <a
                href="/login"
                className="rounded-xl border border-black/10 bg-white px-6 py-3 font-semibold text-[#111827] transition hover:bg-[#f4f1ea]"
              >
                Log In
              </a>
              ...
              <a
                href="/signup"
                className="rounded-xl bg-[#111827] px-6 py-3 font-semibold text-white transition hover:bg-black"
              >
                Create Account
              </a>
            </div>
      ...
      <section className="px-6 pb-28 pt-36">
        <div className="mx-auto max-w-7xl">
          ...
          {(message || errorMessage) && (
            <div
              className={`mt-8 rounded-2xl border px-5 py-4 text-sm font-semibold shadow-sm ${
                errorMessage
                ...
                >
                  <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
                    <div className="max-w-3xl">
                      <div
                        className={`inline-flex rounded-full border px-4 py-2 text-xs font-bold uppercase tracking-[0.18em] ${priorityStyle(
                          request.urgency
                        )}`}
                      >
                      ...
                      <h2 className="mt-5 text-3xl font-semibold tracking-[-0.03em] text-[#111827]">
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 px-6 backdrop-blur-sm">
          <div className="w-full max-w-2xl rounded-[2rem] border border-black/10 bg-white p-8 shadow-2xl">
            ...
            <textarea
              ...
              className="mt-6 w-full resize-none rounded-2xl border border-black/10 bg-[#f8f6f1] px-5 py-4 text-sm leading-7 text-[#111827] outline-none transition focus:border-[#2563eb] focus:ring-4 focus:ring-[#2563eb]/10"
            />
            ...
            <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
              <button
                ...
                className="rounded-xl border border-black/10 bg-white px-5 py-3 text-sm font-semibold text-[#111827] transition hover:bg-[#f4f1ea]"
              >
                Cancel
              </button>
              ...
              <button
                ...
                className="rounded-xl bg-[#111827] px-5 py-3 text-sm font-semibold text-white transition hover:bg-black disabled:cursor-not-allowed disabled:opacity-60"
              >
                {updatingAction === `${contactRequest.id}-contacted`
                  ? "Sending..."
